# edf Reproduction / Root Cause / Fix Design Templates

> 配套 `edf-problem-fix/SKILL.md`。提供 DTS / hotfix 三个核心过程文件的最小模板。
...
> 这是临时的测试设计要点。若需要正式 AR 实现设计，下一节点是 `edf-ar-design`，测试设计章节应在那里完整化。
...
- Next Action Or Recommended Skill:        # edf-tdd-implementation / edf-ar-design / edf-component-design / edf-specify / edf-workflow-router
- 选择理由:
