# edf AR Design Review Rubric

> 配套 `edf-ar-design-review/SKILL.md`。展开 8 维度评分细则与 rule IDs。
...
- `AD6.1` 测试用例最小字段齐全（见 `edf-ar-design/references/test-design-section-contract.md`）
