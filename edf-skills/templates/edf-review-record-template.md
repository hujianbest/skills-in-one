...
- 这是 edf review 记录通用模板，可用于 spec-review / component-design-review / ar-design-review / tasks-review / test-check / code-review。
...
- reroute_via_router:                      # true / false（结论无法唯一映射下一步时为 true 并指向 edf-workflow-router）
