...
- AR 设计通过后 tasks 未产出 / tasks-review 未通过 → 不得路由到 `devflow-tdd-implementation`，必须回 `devflow-tasks` / `devflow-tasks-review`
...
| `devflow-ar-design-review` | 实现 profile | `devflow-tasks` | `devflow-ar-design` |
| `devflow-tasks` | 实现 profile | `devflow-tasks-review` | `devflow-tasks` / `devflow-ar-design` |
| `devflow-tasks-review` | 实现 profile | `devflow-tdd-implementation`（锁定 Current Active Task） | `devflow-tasks` |
