...
devflow 的 review 节点（spec-review / component-design-review / ar-design-review / tasks-review / test-checker / code-review）必须由**独立 reviewer 角色或 subagent** 执行，理由：
...
- `target_skill`：`devflow-spec-review` / `devflow-component-design-review` / `devflow-ar-design-review` / `devflow-tasks-review` / `devflow-test-checker` / `devflow-code-review`
...
SR-flow 中 `devflow-ar-design-review` / `devflow-tasks-review` / `devflow-test-checker` / `devflow-code-review` 不应被派发；如果发生，`devflow-router` 应在派发前拦截，或 reviewer 返回 `阻塞`(workflow) + `reroute_via_router=true`。
...
| `devflow-ar-design-review` | `devflow-tasks` | `devflow-ar-design` | `devflow-ar-design` | `devflow-router` |
| `devflow-tasks-review` | `devflow-tdd-implementation` | `devflow-tasks` | `devflow-tasks` / `devflow-ar-design` | `devflow-router` |
