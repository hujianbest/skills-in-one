# progress.md (shared template for test-checker eval fixtures)
...
The per-scenario fixture's own `progress.md` may override `Current Active Task`, `Workflow Profile`, etc.; the rest are stable across all test-checker eval scenarios.
