...
`devflow-completion-gate` / `devflow-ar-design` / `devflow-test-checker` / `devflow-code-review` / `devflow-problem-fix` **不**适用于 SR 工作项；SR 走 `requirement-analysis` profile，仅经过 specify → spec-review → (可选) component-design → finalize。
...
using-devflow, devflow-router, devflow-specify, devflow-spec-review, devflow-component-design, devflow-component-design-review, devflow-ar-design, devflow-ar-design-review, devflow-tdd-implementation, devflow-test-checker, devflow-code-review, devflow-completion-gate, devflow-finalize, devflow-problem-fix.
