# progress.md (eval fixture: tdd-complete-no-test-check)
...
TDD has just produced the implementer handoff (DONE). `reviews/test-check.md` does NOT exist yet. This fixture exists to verify the router refuses to skip `devflow-test-checker` even when a leaf or a user requests `devflow-code-review` directly.
